...
const database = {
    ...
    manufacturing: [
        ...
        { nama: "Joko Mardiono", submit: [0, 0, 0, 10, 8, 12, 13, 2, 0, 0, 0, 0] },
        { nama: "Mukhlisin", submit: [0, 0, 0, 9, 1, 9, 13, 2, 0, 0, 0, 0] },
        ...
        { nama: "Agus Widodo", submit: [0, 0, 0, 7, 12, 9, 16, 4, 0, 0, 0, 0] },
        { nama: "Febri Fani Rizawanto", submit: [0, 0, 0, 5, 14, 5, 15, 3, 0, 0, 0, 0] },
        { nama: "Ngadino", submit: [0, 0, 0, 8, 13, 8, 16, 3, 0, 0, 0, 0] },
        { nama: "Herwanto", submit: [0, 0, 0, 7, 13, 10, 13, 3, 0, 0, 0, 0] },
        { nama: "Bangun Soleh Saputra", submit: [0, 0, 0, 8, 10, 9, 12, 3, 0, 0, 0, 0] },
        { nama: "Nur Holik", submit: [0, 0, 0, 1, 13, 5, 16, 3, 0, 0, 0, 0] },
        ...
        { nama: "Harianto", submit: [0, 0, 0, 4, 10, 11, 14, 1, 0, 0, 0, 0] },
    ...
    quality: [
        ...
        { nama: "Suwandi", submit: [0, 0, 0, 7, 13, 23, 20, 4, 0, 0, 0, 0] },
        { nama: "Akhmad Arifin", submit: [0, 0, 0, 2, 9, 6, 3, 1, 0, 0, 0, 0] },
        { nama: "Irzani", submit: [0, 0, 0, 15, 11, 21, 5, 3, 0, 0, 0, 0] },
        { nama: "Toto Pamungkas", submit: [0, 0, 0, 20, 5, 24, 17, 2, 0, 0, 0, 0] },
        ...
        { nama: "Muhamad Isma Riyanto", submit: [0, 0, 0, 18, 8, 22, 14, 4, 0, 0, 0, 0] },
        { nama: "Chulam Muhammad Irsyad", submit: [0, 0, 0, 20, 8, 25, 17, 6, 0, 0, 0, 0] },
        { nama: "Kukuh Prasetyo", submit: [0, 0, 0, 20, 14, 20, 9, 0, 0, 0, 0, 0] },
        { nama: "Bayu Prakasa", submit: [0, 0, 0, 21, 15, 23, 18, 7, 0, 0, 0, 0] },
        { nama: "Darmawan", submit: [0, 0, 0, 15, 22, 31, 37, 7, 0, 0, 0, 0] },
    ...
    engineering: [
        ...
        { nama: "Lilik Nur Pratomo", submit: [0, 0, 0, 29, 14, 3, 29, 10, 0, 0, 0, 0] },
